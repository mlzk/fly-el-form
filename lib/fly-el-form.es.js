...
const FlyElForm = defineComponent({
  ...
  render(props) {
    ...
    const generatorSelect = (item) => {
      ...
      if ((_a2 = item.componentProps) == null ? void 0 : _a2.returnObject) {
    ...
    const generatorOptions = (propItem, data = []) => {
      ...
      return data.map((item) => {
        var _a2;
        const value = ((_a2 = propItem.componentProps) == null ? void 0 : _a2.returnObject) ? item : item[propItem.showValue || "value"];
